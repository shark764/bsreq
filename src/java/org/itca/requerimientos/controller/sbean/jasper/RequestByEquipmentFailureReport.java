 ...
 * @author dfhernandez
 */
@ManagedBean(name = "requestByEquipmentFailureReport")
@SessionScoped
public class RequestByEquipmentFailureReport implements Serializable {
    
    private String selectedJR = "requestByEquipmentFailureReport";
    ...
    public void setModelList(List<SolicitudFallaJasper> modelList) {
     ...
     */
    public RequestByEquipmentFailureReport() {
    }
