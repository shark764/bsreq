 ...
 * @author dfhernandez
 */
@ManagedBean(name = "requestByEquipmentModelReport")
@SessionScoped
public class RequestByEquipmentModelReport implements Serializable {
    
    private String selectedJR = "requestByEquipmentModelReport";
    ...
    public void setModelList(List<SolicitudEquipoJasper> modelList) {
     ...
     */
    public RequestByEquipmentModelReport() {
    }
